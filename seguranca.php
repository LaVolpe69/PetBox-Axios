...
$_SG['banco'] = 'oficinawebbd';            // Banco de dados MySQL
...
function insereUsuario ($nome, $cpf, $senha){
...
$sql = "INSERT INTO usuario (nome, cpf, senha, usuario) VALUES ";
$sql .="('$nome','$cpf','$senha','$cpf')";
